...
CREATE TABLE `room_logs` (
    ...
    `account_id` BIGINT UNSIGNED NOT NULL             COMMENT 'gameserver.accounts.account_id 참조',
    ...
    PRIMARY KEY (`id`),
    KEY `ix_room_logs_account` (`account_id`),
...
CREATE TABLE `login_logs` (
    ...
    PRIMARY KEY (`id`),
    KEY `ix_login_logs_account` (`account_id`)
...
CREATE TABLE `chat_logs` (
    ...
    PRIMARY KEY (`id`),
    KEY `ix_chat_logs_account` (`account_id`),
